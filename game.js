...
var playerY = 3;
var sectionNum = 5;
var firstNum, secondNum, thirdNum,correctnum;
var currentMapCol = eval("sectionCol"+sectionNum);
var currentMap = "section"+sectionNum+currentMapCol;
function findCorrRoom() {
  firstNum = sectionCol5;
  secondNum = eval(("sectionCol" + firstNum));
  thirdNum = eval(("sectionCol" + (firstNum + 1)));

  correctnum = (secondNum + thirdNum);
    if (correctnum > 9)
    {
      correctnum = correctnum - 9;
    }
